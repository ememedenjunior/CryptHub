...
const SignUpPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('bitnex-production.up.railway.app/api/auth/register', {
        method: 'POST',
        headers: {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const response = await fetch(`bitnex-production.up.railway.app/api/auth/verify?token=${verificationCode}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleResendCode = async () => {
    ...
    try {
      ...
      const response = await fetch('bitnex-production.up.railway.app/api/auth/resend', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
